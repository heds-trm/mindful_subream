            ...
            "model": {
                ...
                "sub_modules": {
                    "representation_model": {
                        "class_name": "encoder",
                        "hparams": "<models_dir>/vit-lstm_hparams.json"
                    }
                }
            },
...
- `sub_modules.representation_model`: an `encoder` sub-module using the [ViT-LSTM encoder hparams](./ViT-LSTM_HPARAMS_CONFIGURATION.md#vit-lstm-encoder-configuration). Each temporal phase is encoded by a weight-shared 3D ViT and the sequence of phase embeddings is fused by an LSTM into a latent representation consumed by the classifier.
...
|--------------------|-----------------|----------|-------------|
| full sequence | `vit-lstm_hparams.json` | `4d_pipeline.json` | all 13 phases |
| 7 phases | `vit-lstm_hparams_7phases.json` | `4d_pipeline_7phases.json` | 0, 2, 4, 6, 8, 10, 12 |
| 4 phases | `vit-lstm_hparams_4phases.json` | `4d_pipeline_4phases.json` | 0, 4, 8, 12 |
| 3 phases | `vit-lstm_hparams_3phases.json` | `4d_pipeline_3phases.json` | 0, 6, 12 |
| 2 middle phases ("mid") | `vit-lstm_hparams_2phases_mid.json` | `4d_pipeline_2phases_mid.json` | 4, 8 |
| first and last phases ("first-last") | `vit-lstm_hparams_2phases_firstlast.json` | `4d_pipeline_2phases_firstlast.json` | 0, 12 |
