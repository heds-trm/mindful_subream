...
While there are high chances that this body part information will not help in the targeted classification task, this example is just to illustrate the capabilities of `mindful`. It is not exploited to enhance the performance of the classification task.
...
> Despite you use our configuration files to ensure a deterministic behavior of the training, we found that software updates in e.g. PyTorch or MONAI
