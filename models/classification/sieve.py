...
class MultimodalSieve(AbstractClassifier, AttentionInterface):
    # region Class/Subclass methods
    @classmethod
    def module_identifier(cls) -> str:
        return "multimodal_sieve"
    ...
    def base_step(self, batch, subset_id: SubsetID, **model_kwargs) -> STEP_OUTPUT:
        return super(MultimodalSieve, self).base_step(batch, subset_id, compute_sieve_loss=True, **model_kwargs)
